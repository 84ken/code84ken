...
<footer class="bg-bath-dark text-denki-200 py-8 px-4">
  ...
  <div class="max-w-7xl mx-auto mt-4 pt-3 border-t border-denki-400/20 text-center text-[11px] text-denki-200/60">
    ♨️ 温浴なかまサイト：
    <a href="https://onsen.schema.tokyo/" class="text-denki-300 hover:text-denki-400 underline decoration-dotted">温泉ソムリエノート</a>
    <span class="mx-1">·</span>
    <a href="https://sauna.llschema.com/" class="text-denki-300 hover:text-denki-400 underline decoration-dotted">SAUNAFULLNESS（サウナ紀行）</a>
  </div>
</footer>
